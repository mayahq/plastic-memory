...
We call it _plastic_ because unlike tradition neural networks which are rigid/hard to update, plastic memory is explicitly _mouldable_ and _flexible_ over the long-term, similar in behaviour to neuroplasticity in biological systems.
